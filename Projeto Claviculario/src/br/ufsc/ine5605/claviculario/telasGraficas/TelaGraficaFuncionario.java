 ...
 * @author pablo
 */
public final class TelaGraficaFuncionario extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae) {
        if(ae.getSource() == botaoNovo){
            controladorFuncionarios.carregarTelaGraficaDadosFuncionarios("Novo Funcionario");
        }else{
